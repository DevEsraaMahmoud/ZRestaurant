                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <a type="text" class="w-100 py-3 btn btn-primary  btn-block" href="{{route('dashboard')}}">Home</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <a type="text" class="w-100 py-3 btn btn-primary  btn-block" href="{{route('user.password')}}">Change Password</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
